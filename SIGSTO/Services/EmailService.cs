...
namespace SIGSTO.Services
{
    public class EmailService
    {
        ...
        public void EnvoyerOTP(string destinataire, string otpCode)
        {
            ...
            message.Subject = "SIGSTO - Code de verification OTP";
            message.IsBodyHtml = true;
            message.Body = $@"
                <div style='font-family: Segoe UI, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;'>
                    <h2 style='color: #0d6efd;'>SIGSTO - Verification de votre email</h2>
                    <p>Bonjour,</p>
                    ...
                    <p style='color: #aaa; font-size: 12px;'>SIGSTO - Plateforme de gestion des stages - ONEE</p>
                </div>";
